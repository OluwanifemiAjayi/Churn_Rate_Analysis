...
![Yearly_price_change_per_subscription_type]()

### Subscription Preferences by Gender
I calculated the subscription counts by gender and plotted the results using a heatmap to visualize all gender's subscription preference.

![Subscription Preferences by Gender]()

### Subscription Preferences by Country
I calculated the subscription counts by country and plotted the results using a heatmap to visualize every country's subscription preference.

![Subscription Preferences by Country]()

I continued my exploratory analysis by finding the most common country, the most effective referral method, the avearge price for each subscription, the most common transaction type and the average duration before changing subscription.
...
## 6. Conclusion
In this project, we performed assessed and cleaned the data, explored subscription preferences and demographics, and analyzed churn rates. The visualizations provided some valuable insights into customer behavior and subscription patterns, which can help in making informed business decisions and strategies. 
...
- Finland is the country with the highest churn rate then followed by Denmark.
...
- All churned customers, regardless of their demographics, should be reached out to and offerred free subscription for a period of time, this should bring back a significant number of those who churned as active customers.
...
- Most of the purchasing and ordering comes from females and males therefore marketing campaigns should be done to target both genders more.
...
- [Customer Subscription and Transaction Dataset](https://github.com/OluwanifemiAjayi/Apple-Sentiment-Analysis/blob/main/Reviews_dataset.xlsx)
